...
function ApiTokenManager({ tokens, availablePermissions, defaultPermissions }) {
  ...
  const setPermissions = (form, permission, value) => {
    ...
    if (data.permissions.includes(permission)) {
      setData(
        "permissions",
        data.permissions.filter((previous) => previous !== permission)
      );
    }
  };
                ...
                <div key={permission}>
                  <label className="flex items-center">
                    <Checkbox
                      ...
                      callback={(value) =>
                        setPermissions(createApiTokenForm, permission, value)
                      }
                    />
                  ...
                  <div key={permission}>
                    <label className="flex items-center">
                      <Checkbox
                        ...
                        callback={(value) =>
                          setPermissions(updateApiTokenForm, permission, value)
                        }
                      />
                      <span className="ml-2 text-sm text-gray-600">
                        {permission}
